    ...
    <div class="lg:flex lg:h-full">
        ...
        <div class="lg:h-full lg:flex-1 lg:px-80 lg:pt-6">
            <div class="my-3 sticky top-0 bg-dashboard z-10 pb-2 lg:pt-4">
                ...
                <p class="text-zinc-300 text-xs">Enter the verification code sent to <span class="font-semibold">{{ auth()->user()->email }}</span></p>
            </div>
            <div class="lg:h-full lg:pb-24 lg:overflow-scroll scrollbar-hide">
                <div class="mb-5">
                    <input wire:model="token" type="text"
                        class="border border-white/10 bg-transparent text-white text-sm py-2.5 sm:py-3 px-2 ps-4 block w-full rounded-lg sm:text-sm focus:outline-0"
                        placeholder="">
                </div>
