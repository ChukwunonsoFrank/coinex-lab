<div x-data class="px-4 lg:px-0 h-full">
    <div class="lg:flex lg:h-full">
        ...
        <div class="lg:h-full lg:flex-1 lg:px-96 lg:pt-6">
            <div class="text-sm text-white rounded-lg bg-dashboard border border-white/10 p-4 mb-5 mt-3" role="alert" tabindex="-1"
            ...
            <div class="lg:h-full lg:pb-24 lg:overflow-scroll scrollbar-hide">
                ...
                <div class="md:px-52">
                    <a wire:click="createDeposit()">
                        <button type="button"
                            class="py-3 cursor-pointer px-4 w-full md:px-6 md:py-3 text-center gap-x-2 text-sm md:text-base font-semibold rounded-lg bg-accent text-black focus:outline-hidden">
                            Confirm payment
                        </button>
                    </a>
                </div>
