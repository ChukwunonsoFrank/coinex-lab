    ...
    <div class="lg:flex lg:h-full">
        ...
        <div class="lg:h-full lg:flex-1 lg:pl-6 lg:pr-4">
            <div class="my-3 sticky top-0 bg-dashboard pb-2 lg:pt-4">
                <h1 class="text-white text-lg md:text-xl lg:text-2xl font-semibold">Withdrawal history</h1>
            </div>
                        ...
                        <div class="flex items-center gap-x-4">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center mb-1.5">
                                    <div class="flex-1">
                                        <span
                                            class="inline-flex items-center gap-x-1 py-0.5 px-2.5 rounded-md text-[10px] {{ $this->getStatusIndicatorColor($withdrawal['status']) }} uppercase font-medium text-white">{{ ucfirst($withdrawal['status']) }}</span>
                                    </div>
